...
import com.sauthi.grabgo.vendor.adapters.OrderDetailsAdapter;
import com.sauthi.grabgo.vendor.global.GlobalFunctions;
import com.sauthi.grabgo.vendor.global.GlobalVariables;
import com.sauthi.grabgo.vendor.services.model.OrderDetailListModel;
...
public class CurrentOrderDetailsActivity extends AppCompatActivity {
    private static final String TAG = "CurrentOrderDetailsActivity",
            BUNDLE_CURRENT_ORDER_DETAILS = "BundleCurrentOrderDetails";
    ...
    private  TextView tv_currency,tv_currency_two,tv_currency_three,tv_currency_four,tv_currency_five,tv_discount;
    private LinearLayout ln_packaging,ln_discount;
    ...
    public static Intent newInstance(Activity activity, OrderModel model) {
        ...
        bundle.putSerializable(BUNDLE_CURRENT_ORDER_DETAILS, model);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //search from home
        if (getIntent().hasExtra(BUNDLE_CURRENT_ORDER_DETAILS)) {
            orderModel = (OrderModel) getIntent().getSerializableExtra(BUNDLE_CURRENT_ORDER_DETAILS);
        ...
        ln_discount=findViewById(R.id.ln_discount);
        tv_currency_five=findViewById(R.id.tv_currency_five);
    ...
    private void setOrderDetails(OrderModel orderModel) {
        ...
        if (orderModel != null && context != null) {
            ...
            if (GlobalFunctions.isNotNullValue(orderModel.getDiscount_price())) {
                tv_discount.setText(orderModel.getDiscount_price());
            }else {
                ln_discount.setVisibility(View.GONE);
            ...
            if (GlobalFunctions.isNotNullValue(orderModel.getCurrency())) {
                tv_currency_five.setText(orderModel.getCurrency());
            }
